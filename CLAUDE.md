...
This project is indexed by GitNexus as **SynapseAI** (2145 symbols, 4884 relationships, 120 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/SynapseAI/process/{processName}` — trace the full execution flow step by step
